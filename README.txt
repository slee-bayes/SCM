...
(2) Sim_SCM_202105.R
: This R code simulates a panel dataset by using the sequential search process in Lee et al. (2021).

(3) Sim_OPT_202105.R
: This R code simulates a panel dataset by using the exhaustive grid search, which gaurantees the optimality of the simulated data. This is used for evaluating the optimality of the sequential choice model.
